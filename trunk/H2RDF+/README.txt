...
In class gr.ntua.h2rdf.indexScans.MapReduceMergeJoinExecutor1, line:163 there is a parameter named taskslots which is set to 5. This defines the number of reduce slots used for the sort-merge join
